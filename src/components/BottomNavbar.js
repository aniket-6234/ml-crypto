...
const bottomNavItem = [
  ...
  },
  {
    ...
    title: "Dashboard",
    is_selected: false,
    iconFill: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M12 1 21.5 6.5V17.5L13 22.4211V11.4234L3.49793 5.92225 12 1ZM2.5 7.6555V17.5L11 22.4211V12.5765L2.5 7.6555Z" fill="rgba(191,194,219,1)"></path></svg>`,
    iconUnFill: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M12 1 21.5 6.5V17.5L13 22.4211V11.4234L3.49793 5.92225 12 1ZM2.5 7.6555V17.5L11 22.4211V12.5765L2.5 7.6555Z" fill="rgba(100,102,128,1)"></path></svg>`,
    slug: "/dashboard",
  },
  {
    id: 3,
